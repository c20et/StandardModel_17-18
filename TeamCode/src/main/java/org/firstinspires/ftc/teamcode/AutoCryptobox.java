...
@Autonomous(name = "Cryptobox", group = "Sensor")
public class AutoCryptobox extends LinearOpMode
{
    ...
    @Override public void runOpMode() {
        ...
        while (opModeIsActive()) {
            telemetry.update();
            telemetry.addData("FORWARD HEADING", "Forward heading: " + angles.firstAngle);
        }
    }
